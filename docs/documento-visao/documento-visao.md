...
- Devem ser feitos testes de usabilidade e um design cliente como centro, fazendo uma documentação clara com as devidas manifestações do cliente.  <br><br>
...
- Devem ser feitas como replanejamento avaliar o atraso com suas causas e efeitos devendo rever os requisitos isso leva ao replanejamento do cronograma, como estratégia devem diminuir os testes e otimizar tarefas.   <br><br>
</div>
