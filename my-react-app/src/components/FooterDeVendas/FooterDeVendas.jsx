        ...
        <footer>
            ...
            <div className={styles.ConteudoPrincipal}>
                ...
                <div className={styles.LogosDePagamentos}>
                    <img className={styles.LogoDePagamento} src='src/assets/icones/PixLogo.png' alt="" />
                    <img className={styles.LogoDePagamento} src='src/assets/icones/BoletoLogo.png'/>
                </div>
            </div>
            <div clasName={styles.DesenvolvidoPor}>
